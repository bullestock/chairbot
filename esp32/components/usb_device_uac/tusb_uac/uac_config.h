...
/* Provide fallback defaults when UAC config symbols are not defined.
 * This can happen when the component's Kconfig is not loaded or when
 * building with minimal configuration. */
#ifndef CONFIG_UAC_SPEAKER_CHANNEL_NUM
#define CONFIG_UAC_SPEAKER_CHANNEL_NUM  1
#endif
...
#else
// SPEAK_CHANNEL_NUM is 0, define empty macro to allow compilation
#define INPUT_CTRL
#endif
...
#else
// MIC_CHANNEL_NUM is 0, define empty macro to allow compilation
#define MIC_CTRL
#endif
