...
public:
     ...
     */
    static bool playFile(const std::string& filePath, float volume = 0.7f);
     ...
     */
    static bool playFileWithProgress(const std::string& filePath, float volume = 0.7f,
     ...
     */
    static bool getFileInfo(const std::string& filePath, MP3Decoder::MP3Info* info);
