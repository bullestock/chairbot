...
public:
     ...
     */
    bool decodeFile(const std::string& filePath, int16_t** pcmBuffer, size_t* pcmSize, MP3Info* info = nullptr);
     ...
     */
    bool startStreaming(const std::string& filePath, StreamCallback callback);
     ...
     */
    bool getFileInfo(const std::string& filePath, MP3Info* info);
