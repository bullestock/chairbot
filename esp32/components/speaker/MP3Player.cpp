...
bool MP3Player::playFile(const std::string& filePath, float volume) {
    return playFileWithProgress(filePath, volume, nullptr);
}

bool MP3Player::playFileWithProgress(const std::string& filePath, float volume, 
...
bool MP3Player::getFileInfo(const std::string& filePath, MP3Decoder::MP3Info* info) {
